...
angular.module('bootstrapLightbox').provider(
		...
		function() {
			 ...
			 * Large image url
			 */
			this.getImageLargeUrl = function(image) {
			...
			this.$get = [ '$document', '$injector', '$uibModal', '$timeout', 'ImageLoader',
					function($document, $injector, $uibModal, $timeout, ImageLoader) {
						...
						Lightbox.setImage = function(newIndex) {
							...
							var imageLargeUrl = Lightbox.getImageLargeUrl(image);
							...
							var success = function(properties) {
								...
								ImageLoader.load(imageLargeUrl).then(function() {
									successLarge(imageLargeUrl);
								}, function() {
									successLarge(null);
								});
